...
class _HomeViewState extends State<HomeView> {
  ...
  List<String> categories = ['Top 100! You should watch them!','Best Latest \n releases', 'Top Movies \n by Genre', ' Best Movies of all time'];
    ...
    return Row(
      children: <Widget>[
        GestureDetector(
          ...
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context) => TopMovieFilter(title: categories[section],)));
          },
        ),
        GestureDetector(
          child: _section(TypeOfCard.splited, section + 1),
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context) => TopMovie()));
          },
        ),
      ],
      mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: <Widget>[
              ClipRRect(
                child: FadeInImage(
                  ...
                  image: NetworkImage('http://image.tmdb.org/t/p/w185//uXDfjJbdP4ijW5hWSBrPrlKpxab.jpg'),
                  height: heigthMovie,
                  width: widthMovie,
                  fit: BoxFit.cover,
                ),
